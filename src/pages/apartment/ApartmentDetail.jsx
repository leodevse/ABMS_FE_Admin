...
export default function ApartmentDetail() {
  ...
  const [actionLoading, setActionLoading] = useState(false); // Trạng thái khi đang xử lý API Move Out

  // 1. Hàm lấy dữ liệu chi tiết (tách riêng để tái sử dụng khi refresh)
  ...
  // 2. Hàm xử lý Cư dân rời đi (Move Out)
  const handleMoveOut = async (residentId, fullName) => {
    const confirmMsg = `Bạn có chắc chắn muốn xác nhận cư dân "${fullName}" rời khỏi căn hộ này không?\n\nThao tác này sẽ cập nhật ngày rời đi và thay đổi trạng thái căn hộ nếu không còn người ở.`;
      ...
      <div className="page-header" style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "0.75rem" }}>
            ...
            >
              <Plus size={18} style={{ marginRight: "8px" }} /> Xem lịch sử cư
              trú
            </button>
          </div>
        </div>
          ...
          <div className="card">
            ...
            >
              ...
              <span className="badge badge--active">
                {apartment.residents?.length || 0} Người
              </span>
            </div>
                  ...
                  {apartment.residents && apartment.residents.length > 0 ? (
                    apartment.residents.map((res, idx) => (
                      <tr key={idx} className="table-row-hover">
                        ...
                        <td>
                          <span
                            className={`badge ${res.residentType === "OWNER" ? "badge--active" : "badge--confirmed"}`}
                          >
                        ...
                        <td style={{ fontSize: "0.9rem" }}>
                          {new Date(res.assignedAt).toLocaleDateString("vi-VN")}
                        </td>
                        <td
                        ...
                        >
                          <button
                            ...
                            onClick={() => handleMoveOut(res.id, res.fullName)}
                          >
                            <LogOut size={14} /> Rời đi
                          </button>
                        </td>
                      </tr>
                    ))
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          Căn hộ này chưa có cư dân đăng ký.
                        </div>
                        <button
        ...
        >
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: "12px",
                  background:
                    apartment.status === "AVAILABLE" ? "#f0fdf4" : "#fff7ed",
                  border: `1px solid ${apartment.status === "AVAILABLE" ? "#bbf7d0" : "#ffedd5"}`,
                  textAlign: "center",
                }}
              >
                <label
                  style={{
                    ...
                    textTransform: "uppercase",
                    color:
                      apartment.status === "AVAILABLE" ? "#166534" : "#9a3412",
                    marginBottom: "4px",
                  }}
                >
                  Trạng thái căn hộ
                ...
                <div
                  style={{
                    ...
                    fontSize: "1.2rem",
                    color:
                      apartment.status === "AVAILABLE" ? "#15803d" : "#c2410c",
                  }}
                >
                  {apartment.status}
                </div>
          ...
          >
            <div className="card-body" style={{ color: "white" }}>
              ...
              >
                Đây là dữ liệu căn hộ thuộc tòa nhà{" "}
                <strong>{apartment.buildingName}</strong>. Mọi thay đổi về cấu
                trúc tầng cần được thực hiện tại mục Quản lý Tòa nhà.
              </p>
            </div>
          </div>
        </div>
