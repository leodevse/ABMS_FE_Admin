    ...
    >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            ...
            <div>
              ...
              <p className="page-header__subtitle">
                Hệ thống quản lý cư dân và nhân viên vận hành
              </p>
            </div>
          </div>
          <button
      ...
      <div className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        >
          ...
          <button className="btn btn-primary" onClick={handleSearchTrigger}>
            Tìm kiếm
          </button>
        </div>
      </div>
      ...
      <div className="card" style={{ border: "1px solid #e2e8f0" }}>
              ...
              {loading ? (
                ...
                users.map((u) => (
                  <tr key={u.id} className="table-row-hover">
                    ...
                    <td>
                      {u.roles?.map((r, i) => {
                        ...
                        const roleColor = {
                          ...
                          MANAGER: { background: "#e0f2fe", color: "#0284c7" },
                          RESIDENT: { background: "#dcfce7", color: "#16a34a" },
                        };
                    ...
                    <td>
                      <span
                        className={`badge ${u.status === "ACTIVE" ? "badge--active" : "badge--draft"}`}
                      >
        ...
        >
          <span style={{ fontSize: "0.875rem", color: "#64748b" }}>
            Trang <strong>{currentPage}</strong> trên{" "}
